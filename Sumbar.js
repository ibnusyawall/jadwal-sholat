...
// wait
req('https://api.banghasan.com/sholat/format/json/jadwal/kota/580/tanggal/' + waktu.data[0].waktu, function (error, response, body){
   ambil = JSON.parse(body)
   console.log('------------------------------------------------'.hijau)
   console.log('|  '.hijau + 'Jadwal Sholat Untuk Provinsi '.biru + ini.data[2].c.biru + '  |'.hijau)
   console.log('------------------------------------------------'.hijau)
