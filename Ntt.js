...
// wait
req('https://api.banghasan.com/sholat/format/json/jadwal/kota/807/tanggal/' + waktu.data[0].waktu, function (error, response, body){
   ambil = JSON.parse(body)
   console.log('------------------------------------------------'.hijau)
   console.log('|  '.hijau + 'Jadwal Sholat Provinsi '.biru + ini.data[2].s.biru + '  |'.hijau)
   console.log('------------------------------------------------'.hijau)
