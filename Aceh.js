...
// wait
req('https://api.banghasan.com/sholat/format/json/jadwal/kota/530/tanggal/' + waktu.data[0].waktu, function (error, response, body){
   ambil = JSON.parse(body)
   if (response.statusCode == 200) {
   console.log('------------------------------------------------'.hijau)
   console.log('|       '.hijau + 'Jadwal Sholat Untuk Provinsi '.biru + ini.data[2].a.biru + '      |'.hijau)
   console.log('------------------------------------------------'.hijau)
   ...
   console.log('------------------------------------------------'.hijau)
      ...
      return  console.error("[".kuning + "!".merah + "]".kuning + " Tidak dapat terkoneksi ke server".kuning +
                                                                  ", silahkan ulangi beberapa saat lagi !".kuning)
   }
})